...
if ( !IS_ADMIN ){
	...
	require_once DIRECTORY_CLASS . "class.stepping.php"; 
	...
	<div id='section-content' class='row' style="margin-top: 20px;">
		<div id="div_list" class="col-xs-12" style="height: 40%; "> 
			<ul class="nav nav-tabs" role="tablist">
				<li><a href="#">Matriz de Escalonamiento</a></li>  
			</ul>
			<div class="row" style="overflow-y:auto;">  
					...
					<div class="tbl_srch_frm">
						<div class="row">
							<div class="col-xs-12 text-right"> 
								<button class='btn' onclick='edit_client(0);' > <i class="fa fa-plus"></i> Alta </button>
							</div> 
						</div>
					</div>
				</div> 
				...
				<div class='col-xs-12'>				
					<table class="table table-striped table-bordered clearfix" id="clients_table"> 
						<thead>
							<tr><td>Minutos</td><td>Nombre</td><td align="center">Acciones</td></tr>
						</thead>
						<tbody><?php echo $stepping->get_stepping_matrix(); ?></tbody> 
					</table> 
